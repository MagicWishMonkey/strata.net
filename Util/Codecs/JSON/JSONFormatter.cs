...
namespace Strata.Util.Codecs.JSON {
    public class JSONFormatter {
        internal bool UseOptimizedDatasetSchema = true;
        internal bool UseFastGuid = true;
        internal bool UseSerializerExtension = true;
        internal bool IndentOutput = false;
        internal bool SerializeNullValues = true;
        ...
        public static T Read<T>(string data) {
            // object o = new JSONFormatter().DecodeJSON(data);
            //return (T)o;
        ...
        public static string Write(object obj) {
            return new JSONFormatter().EncodeJSON(obj);
        }

        public static string Write(object obj, bool indent) {
            return new JSONFormatter().EncodeJSON(obj, true, true, true, true, indent);
        }


        internal string EncodeJSON(object obj) {
            return EncodeJSON(obj, UseSerializerExtension, UseFastGuid, UseOptimizedDatasetSchema, SerializeNullValues);
        }

        internal string EncodeJSON(object obj,
                             bool enableSerializerExtensions) {
                                 return EncodeJSON(obj, enableSerializerExtensions, UseFastGuid, UseOptimizedDatasetSchema, SerializeNullValues);
        }

        internal string EncodeJSON(object obj,
                             bool enableSerializerExtensions,
                             bool enableFastGuid) {
            return EncodeJSON(obj, enableSerializerExtensions, enableFastGuid, UseOptimizedDatasetSchema, SerializeNullValues);
        }
        internal string EncodeJSON(object obj,
                     bool enableSerializerExtensions,
                     bool enableFastGuid,
            ...
            return new JSONWriter(enableOptimizedDatasetSchema, enableFastGuid, enableSerializerExtensions, serializeNullValues, IndentOutput).ConvertToJSON(obj);
        }
...
//            return new JSONReader(json).Decode();
//        }

//        public static T Decode<T>(string json) {
//            object o = new JSONReader(json).Decode();
//            return (T)o;
//        }
...
//            Dictionary<string, object> ht = new JSONReader(json).Decode() as Dictionary<string, object>;
